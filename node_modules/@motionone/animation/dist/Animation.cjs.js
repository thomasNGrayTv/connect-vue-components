...
class Animation {
    constructor(output, keyframes = [0, 1], { easing: easing$1 = utils.defaults.easing, duration = utils.defaults.duration, delay = utils.defaults.delay, endDelay = utils.defaults.endDelay, repeat = utils.defaults.repeat, offset, direction = "normal", } = {}) {
        this.startTime = null;
        this.rate = 1;
        this.t = 0;
        ...
        const interpolate$1 = interpolate.interpolate(keyframes, offset, utils.isEasingList(easing$1)
            ? easing$1.map(easing.getEasingFunction)
            : easing.getEasingFunction(easing$1));
        this.tick = (timestamp) => {
            var _a;
            if (this.pauseTime)

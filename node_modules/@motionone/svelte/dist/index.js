...
function instance($$self, $$props, $$invalidate) {
	const omit_props_names = ["initial","animate","hover","press","inView","variants","transition"];
	...
	$$self.$$set = $$new_props => {
		...
		if ('variants' in $$new_props) $$invalidate(8, variants = $$new_props.variants);
		if ('transition' in $$new_props) $$invalidate(9, transition = $$new_props.transition);
